...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    setUserInfo: function setUserInfo() {
      ...
      _api__WEBPACK_IMPORTED_MODULE_0__["default"].post('/api/auth/me').then(function (result) {
    ...
    update: function update() {
      ...
      _api__WEBPACK_IMPORTED_MODULE_0__["default"].patch(' api/auth/user/update', {
        ...
        _this2.password = _this2.password_confirmation = '';
        _this2.success = 'Update successful';
...
var render = function () {
  ...
  return _c(
    "div",
    { staticClass: "p-4 d-flex align-items-center justify-content-center row" },
    [
      _c(
        "form",
        { staticClass: "col-lg-4 col-sm-12 border-1 border-light border p-2" },
        [
          _c("h1", { staticClass: "text-center" }, [_vm._v("Settings")]),
          _vm._v(" "),
